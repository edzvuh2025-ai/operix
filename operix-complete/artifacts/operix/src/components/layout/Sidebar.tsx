...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#0f1117] border-r border-[#1e2028] p-6 h-screen sticky top-0">
      <h1 className="text-2xl font-bold mb-8 text-blue-600">Operix</h1>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-[#1e2028] hover:text-white'
              )
            }
          >
